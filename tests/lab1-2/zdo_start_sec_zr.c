...
#ifndef ZB_SECURITY zb_apsde_data_request
...
/**
 * deley between receiving and sending
*/
zb_uint16_t Time = 1;
MAIN()
{
...
static void send_data(zb_buf_t *buf)
{
  ...
  ZB_SCHEDULE_ALARM(zb_apsde_data_request, ZB_REF_FROM_BUF(buf),Time * ZB_TIME_ONE_SECOND);
  Time++;
}
